    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => {
        this.client.connect(params).then(({
          ...
          approval().then(resolve).catch(reject).finally(() => web3Modal.closeModal());
        }).catch(reject);
      });
    });
  }
...
const WalletConnect = ({
  ...
  const signTransactions = transactions => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < transactions.length; i += 1) {
      ...
      const tx = nearAPI.transactions.createTransaction(transactions[i].signerId, nearAPI.utils.PublicKey.from(publicKey.toString()), transactions[i].receiverId, accessKey.nonce + i + 1, transaction.actions.map(action => createAction(action)), nearAPI.utils.serialize.base_decode(block.header.hash));
      const [, signedTx] = yield nearAPI.transactions.signTransaction(tx, signer, transactions[i].signerId, options.network.networkId);
  ...
  const requestSignTransaction = transaction => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tx = nearAPI.transactions.createTransaction(transaction.signerId, nearAPI.utils.PublicKey.from(account.publicKey), transaction.receiverId, accessKey.nonce + 1, transaction.actions.map(action => createAction(action)), nearAPI.utils.serialize.base_decode(block.header.hash));
  ...
  const requestSignTransactions = transactions => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < transactions.length; i += 1) {
      ...
      txs.push(nearAPI.transactions.createTransaction(transaction.signerId, nearAPI.utils.PublicKey.from(account.publicKey), transaction.receiverId, accessKey.nonce + i + 1, transaction.actions.map(action => createAction(action)), nearAPI.utils.serialize.base_decode(block.header.hash)));
    }
    ...
    signIn({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          }, qrCodeModal, params.projectId, chainId);
          yield requestSignIn({
